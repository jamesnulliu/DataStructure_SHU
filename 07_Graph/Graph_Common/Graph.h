...
public:
    ...
    struct Vertex { ElemTy data; Sizet indegree; std::list<Index> adjList; };
...
public:
    ...
    constexpr void setData(Index vertI, const ElemTy& data) { vert_vec[vertI].data = data; }
    constexpr Vertex& getVertR(Index vertI) { return vert_vec[vertI]; }
    constexpr ElemTy& getDataR(Index vertI) { return vert_vec[vertI].data; }
