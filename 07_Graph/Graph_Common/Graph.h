...
#include <vector>
#include <list>
template <class VertDataTy = char>
class Graph
{
public:
...
public:
    ...
    constexpr void setData(Index vertI, const VertDataTy& data) { vert_vec[vertI].data = data; }
    constexpr Vertex& getVertR(Index vertI) { return vert_vec[vertI]; }
    constexpr VertDataTy& getDataR(Index vertI) { return vert_vec[vertI].data; }
